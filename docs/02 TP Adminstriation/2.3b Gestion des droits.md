...
Suite à la remontée à la direction d’incidents et de manquements ayant conduit à l’exposition de données personnelles, vous êtes chargés de produire un document permettant de :
...
Ce document est a rendre sur moodle. Considérez que ce document est à destination de la Direction. Il doit reposer exclusivement sur des faits observables et des preuves vérifiables pas sur une longue suite d'imprimé écrans que la Direction n'a que faire. 

> [!NOTE] Barème de notation (note /20)
> La note attribuée n’évalue pas la capacité à reproduire des commandes vues dans le TP,
> mais la **crédibilité du document produit** et sa capacité à **aider la direction
> à comprendre la situation et à sortir de la crise**.
>
> **Démarche attendue :**  
...
>
> - longues suites de captures d’écran ou d’imprimés écran ;
> - listes de commandes sans explication ni lien avec un constat ;
> - affirmations non démontrées (_« les droits étaient incorrects »_, _« problème de sécurité »_) ;
> - jugements subjectifs (_dangereux_, _incohérent_, _mal configuré_) sans preuve associée ;
> - validations du type _« testé, ça marche »_ ;
> - tout élément reposant sur la confiance ou l’opinion plutôt que sur un fait vérifiable.
