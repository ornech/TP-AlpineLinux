...
Lorsque le programme associé au compte est un shell interactif (`sh`, `bash`, `ksh`), celui-ci s’exécute **dans un environnement déjà existant**, mis en place lors de l’ouverture de la session.  
