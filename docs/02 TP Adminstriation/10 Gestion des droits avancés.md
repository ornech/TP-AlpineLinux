...
Lorsqu’une session utilisateur est ouverte, le système définit non seulement une identité (UID, groupes), mais aussi **des règles qui influencent le comportement des processus**, notamment lors de la création de fichiers et de répertoires.
