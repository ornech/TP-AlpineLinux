...
> > En vous rendant à la machine à café vous surprenez une discussion entre 2 collègues :
...
Dans un système multi-utilisateurs, ce genre de situation n’est pas une anecdote : c’est un **symptôme**. Des accès trop larges à des données sensibles, et des accès manquants à des ressources critiques, traduisent une **mauvaise gestion des droits** sur les fichiers et répertoires.

Sous Linux, ce sont les **permissions** qui déterminent concrètement ce qu’un utilisateur peut lire, modifier ou exécuter.

> [!NOTE] Présentation du contexte professionnel
> 
> Le serveur de fichiers Linux que vous héritez a été configuré par un prestataire dont la définition du concept de _sécurité_ reste à ce jour un mystère.
> 
