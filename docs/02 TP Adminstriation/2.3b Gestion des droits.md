...
1. analyser l’existant sans tout casser ;    
2. identifier les erreurs de droits et de structure ;
3. proposer et appliquer des corrections cohérentes avec l’organisation de l’entreprise ;
4. vérifier, pour chaque service (DEV, INFRA, COM, DIR), que les accès correspondent bien à ce qui est attendu.

Mais avant de commencer, récupérez ce script et exécutez le en root sur votre VM. 

> [!NOTE] 
> Jouez le jeu, ne regardez pas ce que fait ce script ... de toute façon vous vous en doutez ... c'est un carnage !
...
echo "=== Environnement massacré par le prestataire est prêt ==="
