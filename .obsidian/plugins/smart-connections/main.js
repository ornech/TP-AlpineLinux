/*! smart-connections-obsidian v4.1.1 | (c) 2025 🌴 Brian (Brian Petro) */
...
var import_obsidian48 = __toESM(require("obsidian"), 1);
...
async function post_process7(env, container, params = {}) {
  ...
  const render_oauth_login_section = () => {
    ...
    if (!token) {
      const setting = new import_obsidian12.Setting(login_container).setName("Connect Account").setDesc("Log in with your Smart Connections supporter key.");
      setting.addButton((btn) => {
        btn.setButtonText("Login");
        btn.onClick(() => initiate_oauth_login());
      });
    } else {
      const setting = new import_obsidian12.Setting(login_container).setName("OAuth Token").setDesc(token.slice(0, 16) + "...");
      setting.addButton((btn) => {
...
async function post_process9(model, container, params) {
  ...
  (0, import_obsidian16.setIcon)(icon_el, get_test_result_icon_name(model));
...
async function render13(env, opts = {}) {
  let html = await build_html13.call(this, env, opts);
  const frag = this.create_doc_fragment(html);
  const container = frag.firstElementChild;
  post_process12.call(this, env, container, opts);
  return container;
}
async function post_process12(env, frag, opts = {}) {
...
function build_html14(env, params = {}) {
  return `<div>
...
async function render14(env, params = {}) {
  const html = await build_html14.call(this, env, params);
  const frag = this.create_doc_fragment(html);
  const container = frag.firstElementChild;
  post_process13.call(this, env, container, params);
  return container;
}
async function post_process13(env, container, params = {}) {
...
async function build_html15(env, params = {}) {
...
async function render15(env, params = {}) {
  this.apply_style_sheet(style_default2);
  const html = await build_html15.call(this, env, params);
  const frag = this.create_doc_fragment(html);
  const container = frag.firstElementChild;
  post_process14.call(this, env, container, params);
  return container;
}
...
var ExcludedSourcesModal = class extends import_obsidian18.Modal {
  /**
...
async function render16(env, opts = {}) {
  const html = await build_html16.call(this, env, opts);
  const frag = this.create_doc_fragment(html);
  const container = frag.firstElementChild;
...
// node_modules/obsidian-smart-env/src/modals/exclude_folders_fuzzy.js
var ExcludedFoldersFuzzy = class extends import_obsidian19.FuzzySuggestModal {
  /**
...
async function build_html17(env, opts = {}) {
  return `
      <div class="setting-component">
        <div class="setting-item">
          <div class="info setting-item-info">
...
async function render17(env, opts = {}) {
  const html = await build_html17.call(this, env, opts);
  const frag = this.create_doc_fragment(html);
  const container = frag.firstElementChild;
  post_process16.call(this, env, container, opts);
  return container;
}
...
var smart_env_config = {
  ...
  components: {
    ...
    settings_notifications: { render: render13 },
    settings_reimport_sources: { render: render14 },
    settings_smart_env: { render: render15 },
    settings_sources_excluded_info: { render: render16 },
    settings_sources_folder_exclusions: { render: render17 },
...
// src/components/connections-list-item/v3.js
async function build_html27(result, opts = {}) {
...
async function render27(result_scope, opts = {}) {
  ...
  let html = await build_html27.call(this, result_scope, opts);
  const frag = this.create_doc_fragment(html);
  const container = frag.querySelector(".sc-result");
  post_process26.call(this, result_scope, container, opts);
  return container;
}
async function post_process26(result_scope, container, opts = {}) {
...
async function post_process29(view, container, opts = {}) {
  ...
  if (!container._has_listeners) {
    ...
    menu_button?.addEventListener("click", (event) => {
      const menu = new import_obsidian42.Menu(view.plugin.app);
      menu.addItem((menu_item) => {
...
var SmartNotices2 = class {
  ...
  _add_mute_button(id, container) {
    const btn = document.createElement("button");
    (0, import_obsidian44.setIcon)(btn, "bell-off");
    btn.addEventListener("click", () => {
      if (!this.settings.muted) this.settings.muted = {};
      this.settings.muted[id] = true;
...
var ReleaseNotesView = class _ReleaseNotesView extends SmartItemView {
  ...
  async render() {
    ...
    await import_obsidian46.MarkdownRenderer.render(
      this.app,
...
function add_smart_dice_icon() {
  (0, import_obsidian47.addIcon)("smart-dice", `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
var SmartConnectionsPlugin = class extends SmartPlugin {
  ...
  // GETTERS
  get obsidian() {
    return import_obsidian48.default;
  }
  get api() {
    return this._api;
  }
